...
Spend the afternoon [iterating over a “files exploring algorithm”](https://github.com/the-guild-org/the-guild-docs/pull/633) (_I love recursive code 🕳_), going back and forth between the actual usage and implementation to discover edge cases.
